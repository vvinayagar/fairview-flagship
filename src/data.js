...
export const campuses = [
  { name: 'Fairview Kuala Lumpur', slug: 'kuala-lumpur', short: 'Kuala Lumpur', place: 'Wangsa Maju, Kuala Lumpur', ages: '3–19 years',
    tags: ['Flagship Campus', 'IB Continuum', 'Since 1978'],
    photo: img('1580582932707-520aed937b7b', 900, 600), hero: img('1580582932707-520aed937b7b', 1600, 1000), tall: img('1580582932707-520aed937b7b', 800, 1200),
    address: 'Lot 4178, Jalan 1/27, Seksyen 1 Wangsa Maju, 53300 Kuala Lumpur',
    phone: '+603-4142 0888', email: 'kl@fairview.edu.my',
    blurb: 'Our flagship Kuala Lumpur campus is the oldest and largest IB World School in Malaysia — a beacon of quality education since 1978. In the heart of Wangsa Maju, it delivers the full IB continuum in a vibrant, purpose-built campus.',
    highlights: ['Full IB continuum: PYP, MYP & Diploma', 'Purpose-built science & innovation labs', 'Award-winning sport and performing arts', 'The founding Fairview campus, est. 1978'] },
  { name: 'Fairview Subang', slug: 'subang', short: 'Subang', place: 'Subang Jaya, Selangor', ages: '3–19 years',
    tags: ['IB Continuum', 'STEM Focus'],
    photo: img('1562774053-701939374585', 900, 600), hero: img('1562774053-701939374585', 1600, 1000), tall: img('1562774053-701939374585', 800, 1200),
  ...
  { name: 'Fairview Ipoh', slug: 'ipoh', short: 'Ipoh', place: 'Ipoh, Perak', ages: '3–19 years',
    tags: ['IB Continuum', 'Boarding Available'],
    photo: img('1577896851231-70ef18881754', 900, 600), hero: img('1577896851231-70ef18881754', 1600, 1000), tall: img('1577896851231-70ef18881754', 800, 1200),
    address: 'Jalan Sultan Azlan Shah, 31350 Ipoh, Perak',
    phone: '+605-321 0888', email: 'ipoh@fairview.edu.my',
    blurb: 'Set in the historic city of Ipoh, this campus offers the full IB continuum with boarding available — ideal for families seeking a nurturing home away from home.',
    highlights: ['Boarding available for older students', 'Full IB continuum: PYP, MYP & Diploma', 'Warm, close-knit community', 'Green, spacious campus grounds'] },
  { name: 'Fairview Penang', slug: 'penang', short: 'Penang', place: 'Bukit Mertajam, Penang', ages: '3–19 years',
    tags: ['IB Continuum', 'Foundation in Music'],
    photo: img('1544717305-2782549b5136', 900, 600), hero: img('1544717305-2782549b5136', 1600, 1000), tall: img('1544717305-2782549b5136', 800, 1200),
  ...
  { name: 'Fairview Johor', slug: 'johor', short: 'Johor', place: 'Johor Bahru, Johor', ages: '3–19 years',
    tags: ['IB Continuum', 'Early Years'],
    photo: img('1533105079780-92b9be482077', 900, 600), hero: img('1533105079780-92b9be482077', 1600, 1000), tall: img('1533105079780-92b9be482077', 800, 1200),
    address: 'Jalan Persiaran Southkey, 80150 Johor Bahru, Johor',
    phone: '+607-336 0888', email: 'johor@fairview.edu.my',
    blurb: 'Our Johor Bahru campus is known for outstanding Early Years provision, giving the youngest learners an inspiring, play-based start before progressing through the full IB continuum.',
  ...
  { name: 'Dominus Arts & Eduresort', slug: 'dominus', short: 'Dominus', place: 'Port Dickson, Negeri Sembilan', ages: 'All ages',
    tags: ['Arts Venue', 'Expeditions'],
    photo: img('1507924538820-ede94a04019d', 900, 600), hero: img('1507924538820-ede94a04019d', 1600, 1000), tall: img('1507924538820-ede94a04019d', 800, 1200),
